    ...
    <div class="space-y-28">
        ...
        <x-container class="py-12">
            ...
            <div class="flex flex-wrap gap-8">
                <x-cards.background-image src="{{ asset('storage/uploads/images/image-1.png') }}" class="aspect-[9/10] flex-1 min-w-64 max-h-96">
                    <x-slot:title>
                        <div class="my-5 mx-7">
                ...
                <x-cards.background-image src="{{ asset('storage/uploads/images/image-2.png') }}" class="aspect-[9/10] flex-1 min-w-64 max-h-96">
                    <x-slot:title>
                        <div class="my-5 mx-7">
                            <div class="text-white text-3xl font-semibold">
                                Terapi Ikan
                ...
                <x-cards.background-image src="{{ asset('storage/uploads/images/image-3.png') }}" class="aspect-[9/10] flex-1 min-w-64 max-h-96">
                    <x-slot:title>
                        <div class="my-5 mx-7">
                            <div class="text-white text-3xl font-semibold">
                                Bazar UMKM
