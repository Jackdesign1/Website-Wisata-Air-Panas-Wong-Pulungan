<nav class="fixed top-0 left-0 right-0 z-50 bg-white border-gray-200 dark:bg-gray-900">
   <div class="flex flex-wrap items-center justify-between p-4 mx-auto max-w-7xl">
         ...
         <ul class="flex flex-col p-4 mt-4 font-medium border border-gray-100 rounded-lg md:p-0 bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
               <a href="/" wire:navigate class="{{
                  ...
                  }} block py-2 px-3 text-gray-900 rounded-sm  dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent md:p-0">Beranda</a>
            </li>
            <li>
               <a href="/about" wire:navigate class="{{
                  request()->routeIs('company-profile.about')?
                     'bg-blue-700 md:text-blue-700 md:bg-transparent'
                     : 'hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700'
                  }} block py-2 px-3 text-gray-900 rounded-sm  dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent md:p-0">Tentang Kami</a>
            </li>
            <li>
            ...
            @auth
               <li>
                  <x-dropdown align="right" width="48">
                     <x-slot name="trigger">
                        <button class="inline-flex items-center px-2 font-medium leading-4 text-gray-900 transition duration-150 ease-in-out bg-white border border-transparent rounded-md hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 dark:text-gray-400 dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none">
