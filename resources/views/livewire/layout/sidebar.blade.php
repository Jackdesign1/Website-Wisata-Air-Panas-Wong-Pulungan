   ...
   <aside id="default-sidebar" class="bg-white sticky top-0 left-0 h-screen pt-16 z-50 w-full transition-transform -translate-x-full sm:translate-x-0 shadow-lg" aria-label="Sidebar">
      <div class="h-full px-3 py-4 overflow-y-auto bg-transparent dark:bg-gray-800">
         <ul class="space-y-2 font-medium">
            <li>
               <a href="{{ route('admin.tour-destination.index') }}" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
